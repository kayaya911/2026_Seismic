...
async function Plotly_Graph_Update(ChNum) {
    ...
    if (PageNo == 0) {
        ...
        if (ChannelList[ChNum].Results.Filter.BaselineCorrection_String != undefined) { 
        ...
        if (ChannelList[ChNum].Results.Filter.FilterName_String != undefined) {
        ...
        // Show Baseline-Row in InforBar
        if (ChannelList[ChNum].Results.Integral.BaselineCorrection_String != undefined) {
        ...
        // Show Filter_ID-Row in InfoBar
        if (ChannelList[ChNum].Results.Integral.FilterName_String != undefined) {
